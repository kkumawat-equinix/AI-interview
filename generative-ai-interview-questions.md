...
3. What is a GAN?
**Answer:** GAN stands for Generative Adversarial Network. It is a model that generates new data by pitting two neural networks against each other: a generator and a discriminator.
